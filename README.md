...
Creación de tabla airport_classification<br>
Identificación y manejo de nulos<br>
Identificación y manejo de duplicados<br>
Identificación y manejo de datos fuera del alcance del análisis<br>
Identificación y manejo de datos inconsistentes en variables categóricas<br>
Unión tablas<br>
Identificación de nuevos datos atípicos y nulos<br>
Identificación y manejo de datos discrepantes en variables numéricas<br>
Creación de nuevas variables

## 2. Análisis Exploratorio de Datos

Resumen estadísticas descriptivas variables<br>
Agrupar datos según variables categóricas<br>
Visualización de datos

## 2. Aplicar técnicas de análisis

Correlación entre variables<br>
Aplicación del modelo de riesgo relativo
